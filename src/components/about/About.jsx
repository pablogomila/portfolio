  ...
  return (
    <>
      <div className="about" id="about">
        <div className="left">
          ...
          <div class="card">
            ...
            <div class="details">
              <div class="center">
                <p>
                  After 14 years of working in the metalurgic industry, I felt
          ...
          <a
            href="https://drive.google.com/file/d/1fzhgRf1jxGAUaHL95lgBjcRqIARbuoSn/view?usp=sharing"
            target="_blank"
            rel="noreferrer"
            class="download"
          >
        ...
        <a className="arrowcont" href="#projectspage">
